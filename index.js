...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
"Because of the closure, nestedFunction() is able to reach out of its own scope and into its parent scope to reach the variable 'internal' allowing it to console.log() it"
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(){
    const lessThanFive =  zooAnimals.filter(item => item.population < 5)
    return lessThanFive
  }
